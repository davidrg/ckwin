char *loginv = "Login Command for Unix, V1.0(003) 28 Feb 85";
...
#define EXP_ALRM	15		/* Time to wait for expect string */
...
static
timeInt() {				/* modem read failure handler, */
...
recvSeq()  {
	...
	*trace = '\0';
	...
	signal(SIGALRM,timeInt);	/* did we get it? */
