...
#ifndef NOSPL
#ifdef DCMDBUF
extern int *count, *terror, *merror, *incase;
#else
extern int count[], terror[], merror[], incase[];
#endif /* DCMDBUF */
...
#ifndef NOSPL
case XYCASE:
    return(success = seton(&incase[cmdlvl]));
#endif /* NOSPL */
...
#ifndef NOSPL
      case 1: return(success = seton(&terror[cmdlvl]));
#else
      case 1: return(success = seton(&terror[tlevel]));
#endif /* NOSPL */
