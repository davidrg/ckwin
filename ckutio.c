char *ckxv = "UNIX Communications support, 5A(104), 10 Dec 92";
...
#ifdef QNX
    static struct timeb ftp;		/* sys/timeb.h */
#endif /* QNX */
...
ttsspd(cps) int cps; {
#ifdef QNX
/* Needed for 38400 on 16-bit architectures */
/* Maybe this is safe in general, but why take chances? */
    unsigned 
#endif /* QNX */
      int s, s2;
