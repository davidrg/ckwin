...
" ",
"SET TERMINAL ATTRIBUTE { BLINK, BOLD, CROSSED-OUT, DIM, OVERLINE, REVERSE,",
"         UNDERLINE, ITALIC } { ON, OFF }",
"  Determines whether real Blinking, Bold, Crossed-Out, Dim, Overline, Reverse,",
"  Italic and Underline are used in the terminal display.  When BLINK is turned",
"  OFF, reverse background intensity is used.  When DIM is turned OFF, dim",
"  characters appear BOLD.  When REVERSE, ITALIC, CROSSED-OUT, OVERLINE and",
"  UNDERLINE are OFF, the colors selected with SET TERMINAL COLOR { OVERLINE,",
"  REVERSE, ITALIC, CROSSED-OUT, UNDERLINE } are used instead.  In K95G, when",
"  BOLD is off, a bold font is not used (the foreground intensity is still set).",
"  This command affects the entire current screen and terminal scrollback buffer.",
" ",
...
"  BLINK, BOLD, CROSSED-OUT-TEXT, CURSOR, DEBUG, DIM, HELP-TEXT, ITALIC,",
"  OVERLINED-TEXT, REVERSE, SELECTION, STATUS-LINE, TERMINAL-SCREEN or ",
"  UNDERLINED-TEXT.",
