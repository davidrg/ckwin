...
" ",
"SET TERMINAL KEYBOARD-MODE { NORMAL, EMACS, RUSSIAN, HEBREW, WP, META, METAESC }",
"  Select a special keyboard mode for use in the terminal screen. METAESC is a",
"  subset of EMACS which does not modify any function key definitions, while ",
"  META shifts characters into the 128-255 range (equivalent to xterms default",
"  behavior.",
" ",
