...
" ",
"SET TERMINAL ATTRIBUTE BLINK OFF COLOR",
"  Turns off real Blinking. Instead of simulating blinking with reverse",
"  background intensity, the colors selected with SET TERMINAL COLOR BLINK are",
