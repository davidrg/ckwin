...
"  buffer.",
" ",
"SET TERMINAL ATTRIBUTE {BLINK, BOLD} OFF COLOR",
"  Turns off real Blinking or Bold. Instead of simulating blinking with ",
"  reverse background intensity or bold with foreground foreground intensity,",
"  the colors selected with SET TERMINAL COLOR { BLINK, BOLD } are used. This",
...
"  BLINK, DEBUG, HELP-TEXT, REVERSE, SELECTION, STATUS-LINE, TERMINAL-SCREEN,",
"  or UNDERLINED-TEXT.",
