/*  C K O U N I . H  --  Unicode/Terminal character-set translations  */

/*
  Copyright (C) 1985, 1999, Trustees of Columbia University in the City of New
  York.
...
#define TX_ELOT928     94               /* Same as ISO 8859-7 */
#define TX_CP10000     95               /* Same as original Apple Quickdraw */
#define TX_CP37        96               /* EBCDIC */
#define TX_CP1255      97		/* Israel Windows */
#define TX_CP1256      98		/* Arabic Windows */
#define TX_CP1258      99		/* Viet Nam Windows */
#define TX_MAZOVIA    100
#define TX_TRANSP     101               /* Transparent - no translation */
#define MAXTXSETS     102		/* Number of terminal character sets */
