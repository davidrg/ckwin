char *protv =                                                     /* -*-C-*- */
"C-Kermit Protocol Module 10.0.170, 14 Apr 2022";

/*
  From 1985 to 2022 (37 years) this file was generated by a
  preprocessor called Wart (ckwart.c) that was modeled on Unix Lex
  since the Kermit protocol is a kind of finite state machine.  But as
  of C-Kermit 10.0 Beta.07, Wart is no more and this is a regular
  source file to be edited directly when changes are needed.
*/
...
static int
#ifdef CK_ANSIC
sgetinit( int reget, int xget )        /* Server end of GET command */
#else
