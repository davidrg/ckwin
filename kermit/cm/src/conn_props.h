...
// Property Sheet: FILE TRANSFER
BOOL CALLBACK	FileTransferPageDlgProc(HWND, UINT, WPARAM, LPARAM);
UINT CALLBACK	FileTransferPageProc(HWND, UINT, LPPROPSHEETPAGE);

// Property Sheet: GUI
BOOL CALLBACK	GuiPageDlgProc(HWND, UINT, WPARAM, LPARAM);
UINT CALLBACK	GuiPageProc(HWND, UINT, LPPROPSHEETPAGE);
