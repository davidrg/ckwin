...
CLEAN : 
	...
	-@erase ".\Release\gui_colors.obj"
	-@erase ".\Release\conn_profile.obj"
	-@erase ".\Release\gui.obj"
	-@erase ".\Release\main.obj"
	-@erase ".\Release\json_color_theme.obj"
	-@erase ".\Release\json_util.obj"
...
CLEAN : 
	...
	-@erase ".\Debug\json_color_theme.obj"
	...
	-@erase ".\Debug\new_conn.obj"
	-@erase ".\Debug\json_util.obj"
	-@erase ".\Debug\logging.obj"
	-@erase ".\Debug\cm.res"
	-@erase ".\Debug\jumplist.obj"
	-@erase ".\Debug\cm.ilk"
	-@erase ".\Debug\cm.pdb"
...
CLEAN : 
	...
	-@erase ".\cm___Wi0\gui_colors.obj"
	-@erase ".\cm___Wi0\json_color_theme.obj"
	...
	-@erase ".\cm___Wi0\json_util.obj"
	-@erase ".\cm___Wi0\cm.res"
	-@erase ".\cm___Wi0\jumplist.obj"
...
SOURCE="\ckwin-dial32\kermit\cm\src\conn_props\gui_colors.cpp"
DEP_CPP_GUI_C=\
	".\..\config_file.h"\
	".\..\conn_props.h"\
	".\..\conn_profile.h"\
...
"$(INTDIR)\gui_colors.obj" : $(SOURCE) $(DEP_CPP_GUI_C) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
SOURCE="\ckwin-dial32\kermit\cm\src\color_theme.h"
...
SOURCE="\ckwin-dial32\kermit\cm\src\json_color_theme.cpp"
DEP_CPP_JSON_CO=\
	".\..\json_color_theme.h"\
	".\..\cJSON\cJSON.h"\
	".\..\color_theme.h"\
...
"$(INTDIR)\json_color_theme.obj" : $(SOURCE) $(DEP_CPP_JSON_CO) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
SOURCE="\ckwin-dial32\kermit\cm\src\json_color_theme.h"
...
SOURCE="\ckwin-dial32\kermit\cm\src\json_util.cpp"
DEP_CPP_JSON_U=\
	".\..\json_util.h"\
	".\..\cJSON\cJSON.h"\
	".\..\json_config.h"\
...
"$(INTDIR)\json_util.obj" : $(SOURCE) $(DEP_CPP_JSON_U) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
SOURCE="\ckwin-dial32\kermit\cm\src\json_util.h"
...
SOURCE="\ckwin-dial32\kermit\cm\src\config_file.cpp"
DEP_CPP_CONFI=\
	".\..\config_file.h"\
	".\..\conn_profile.h"\
	".\..\color_theme.h"\
...
"$(INTDIR)\config_file.obj" : $(SOURCE) $(DEP_CPP_CONFI) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
SOURCE="\ckwin-dial32\kermit\cm\src\conn_props\gui.cpp"
DEP_CPP_GUI_CP=\
	".\..\conn_props.h"\
	".\..\conn_profile.h"\
	".\..\cmstring.h"\
...
"$(INTDIR)\gui.obj" : $(SOURCE) $(DEP_CPP_GUI_CP) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
SOURCE="\ckwin-dial32\kermit\cm\src\conn_props\transfer.cpp"
DEP_CPP_TRANS=\
	".\..\conn_props.h"\
	".\..\conn_profile.h"\
	".\..\cmstring.h"\
...
SOURCE="\ckwin-dial32\kermit\cm\src\jumplist.cpp"
DEP_CPP_JUMPL=\
	"..\jumplist.h"\
	".\..\config_file.h"\
	".\..\conn_profile.h"\
...
"$(INTDIR)\jumplist.obj" : $(SOURCE) $(DEP_CPP_JUMPL) "$(INTDIR)"
   $(CPP) $(CPP_PROJ) $(SOURCE)
...
SOURCE="\ckwin-dial32\kermit\cm\src\jumplist.h"
