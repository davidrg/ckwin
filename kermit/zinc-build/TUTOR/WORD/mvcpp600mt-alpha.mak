...
#    nmake -f mvcpp600.mak dos32       (makes all the DOS TNT extender word tutorials)
#    nmake -f mvcpp600.mak winnt       (makes all the Windows word tutorials)
#    nmake -f mvcpp600.mak win32       (makes all the Windows word tutorials)
...
word232.exe: word2.o32
	$(D32_LINK) @msvc32.lnk $(D32_LINK_OPTS) -out:word232.exe $(D32_OBJS) word2.o32 $(D32_LIBS)

word332.exe: word3.o32 word_win.o32
	$(D32_LINK) @msvc32.lnk $(D32_LINK_OPTS) -out:word332.exe $(D32_OBJS) word3.o32 word_win.o32 $(D32_LIBS)
...
9word2.exe: word2.ob9
	$(W32_LINK) $(W32_LINK_OPTS) -out:9word2.exe $(W32_OBJS) word2.ob9 $(W32_LIBS)

9word3.exe: word3.ob9 word_win.ob9
	$(W32_LINK) $(W32_LINK_OPTS) -out:9word3.exe $(W32_OBJS) word3.ob9 word_win.ob9 $(W32_LIBS)
